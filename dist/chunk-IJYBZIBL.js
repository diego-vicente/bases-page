...
var BoardView = ({ entries, view, basesData, total, locale }) => {
  ...
  return /* @__PURE__ */ jsxs("div", {
    class: "bases-board-wrapper",
    children: [
      /* @__PURE__ */ jsx("div", {
        class: "bases-view-meta",
        children: formatMessage(localeStrings.showingCount, {
      ...
      /* @__PURE__ */ jsx("div", {
        ...
        children: Array.from(groups.values()).map((group) =>
          /* @__PURE__ */ jsxs("div", {
            class: "bases-board-column",
            children: [
              /* @__PURE__ */ jsxs("div", {
                class: "bases-board-column-header",
                children: [
                  /* @__PURE__ */ jsx("span", { children: group.label }),
                  /* @__PURE__ */ jsx("span", {
                    class: "bases-board-count",
                    children: group.entries.length,
                  }),
                ],
              }),
              /* @__PURE__ */ jsx("div", {
                class: "bases-board-column-body",
                children: group.entries.map((entry) => {
                  const ctx = { slug: entry.slug };
                  return /* @__PURE__ */ jsxs("div", {
                    class: "bases-board-card",
                    children: [
                      /* @__PURE__ */ jsx("a", {
                        href: `/${entry.slug}`,
                        class: "internal",
                      ...
                      columns.length > 0 &&
                        /* @__PURE__ */ jsx("div", {
                          class: "bases-board-card-meta",
                          children: columns.map((column) => {
                            const value = resolveEntryPropertyValue(column, entry);
                            if (isEmptyValue(value)) return null;
                            return /* @__PURE__ */ jsxs("div", {
                              class: "bases-board-card-row",
                              children: [
                                /* @__PURE__ */ jsx("span", {
                                  class: "bases-board-card-label",
                                  children: getColumnLabel(column, basesData),
                                }),
                                /* @__PURE__ */ jsx("span", {
                                  class: "bases-board-card-value",
                                  children: renderCellValue(value, ctx),
                                }),
                              ],
                            });
                          }),
...
var CardsView = ({ entries, view, basesData, total, locale }) => {
  ...
  const gridStyle =
    typeof cardSize === "number" && cardSize > 0
      ...
      : void 0;
  return /* @__PURE__ */ jsxs("div", {
    class: "bases-cards-wrapper",
    children: [
      /* @__PURE__ */ jsx("div", {
        class: "bases-view-meta",
        children: formatMessage2(localeStrings.showingCount, {
          count: entries.length,
          total,
        }),
      }),
                  ...
                  /* @__PURE__ */ jsx("div", {
                    ...
                    children: columns.map((column) => {
                      ...
                      return /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("span", {
                            class: "bases-card-label",
                            children: getColumnLabel(column, basesData),
                          }),
                          /* @__PURE__ */ jsx("span", {
                            class: "bases-card-value",
                            children: renderCellValue(value, ctx),
                          }),
                        ],
                      });
...
var GalleryView = ({ entries, view, total, locale }) => {
  ...
  return /* @__PURE__ */ jsxs("div", {
    class: "bases-gallery-wrapper",
    children: [
      /* @__PURE__ */ jsx("div", {
        class: "bases-view-meta",
        children: formatMessage3(localeStrings.showingCount, {
          count: entries.length,
          total,
        }),
      }),
      /* @__PURE__ */ jsx("div", {
        ...
        children: entries.map((entry) => {
          ...
          const imageSrc = imageValue ? String(imageValue) : "";
          return /* @__PURE__ */ jsxs("div", {
            class: "bases-gallery-item",
            children: [
              /* @__PURE__ */ jsx("div", {
                class: "bases-gallery-image",
                children: imageSrc
                  ? /* @__PURE__ */ jsx("img", { src: imageSrc, alt: entry.title, loading: "lazy" })
                  : /* @__PURE__ */ jsx("span", {
...
var ListView = ({ entries, view, basesData, total, locale }) => {
  ...
  const localeStrings = i18n(locale).components.bases;
  return /* @__PURE__ */ jsxs("div", {
    class: "bases-list-wrapper",
    children: [
      /* @__PURE__ */ jsx("div", {
        class: "bases-view-meta",
        children: formatMessage4(localeStrings.showingCount, {
          count: entries.length,
          total,
        }),
      }),
        ...
        children: entries.map((entry) => {
          ...
          return /* @__PURE__ */ jsxs("li", {
            ...
            children: [
              ...
              columns.length > 1 &&
                /* @__PURE__ */ jsx("div", {
                  class: "bases-list-meta",
                  children: columns.slice(1).map((column) => {
                    const value = resolveEntryPropertyValue(column, entry);
                    if (isEmptyValue(value)) return null;
                    return /* @__PURE__ */ jsxs("span", {
                      class: "bases-list-chip",
                      children: [
...
var TableView = ({ entries, view, basesData, total, locale }) => {
  ...
  const localeStrings = i18n(locale).components.bases;
  return /* @__PURE__ */ jsxs("div", {
    class: "bases-table-wrapper",
    children: [
      /* @__PURE__ */ jsx("div", {
        class: "bases-view-meta",
        children: formatMessage5(localeStrings.showingCount, {
          count: entries.length,
          total,
        }),
      }),
...
var BasesBody_default = (opts) => {
  const Component = (props) => {
    ...
    if (!basesData) {
      return /* @__PURE__ */ jsx("div", {
        class: "bases-page bases-empty",
        children: localeStrings.noData,
      });
    }
    ...
    if (views.length === 0) {
      return /* @__PURE__ */ jsx("div", {
        class: "bases-page bases-empty",
        children: localeStrings.noViews,
      });
    }
    ...
    return /* @__PURE__ */ jsxs("div", {
      class: "bases-page",
      "data-initial-view": initialIndex,
      children: [
        viewCssChunks.length > 0 &&
          /* @__PURE__ */ jsx("style", {
            dangerouslySetInnerHTML: { __html: viewCssChunks.join("\n") },
          }),
        /* @__PURE__ */ jsx(ViewSelector, { views, activeIndex: initialIndex, locale }),
        /* @__PURE__ */ jsx("div", {
          class: "bases-view-container",
          children: views.map((view, index) => {
              ...
              children:
                entries.length === 0
                  ...
                  : Renderer
                    ...
                    : /* @__PURE__ */ jsxs("div", {
                        class: "bases-empty",
                        children: ["Unknown view type: ", view.type],
                      }),
            });
          }),
        }),
